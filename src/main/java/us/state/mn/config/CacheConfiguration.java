...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, us.state.mn.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, us.state.mn.repository.UserRepository.USERS_BY_EMAIL_CACHE);
